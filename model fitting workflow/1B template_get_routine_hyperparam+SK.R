...
devtools::load_all("D:/Sophy/MSC_EAB/2021_2022/Countdownto2030/UManitoba_consultancy/Bayesian statistical modelling/Phase2/cdroutine")


# where clean routine data are saved
routinedata_processed <- "private/routine data processed/"
# choose indicator
indicator <-  "vmsl" #"ideliv" #"anc4"#"vdpt" # #
...
global_fit1b <- get_fit(indicator = indicator, runstep = runstep, folder_suffix = "run_1")
