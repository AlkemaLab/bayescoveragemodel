...
- routine_data:
  ...
  tibble with iso OR admin1 name, year, indicator_name, routine_value,
  countdownmean routine_value is the value of the routine data (eg
  coverage) and countdownmean is the data quality indicator for that
